...
type OrderServiceClient interface {
	...
	ListOrder(ctx context.Context, in *PaginationRequest, opts ...grpc.CallOption) (*ListOrderResponse, error)
}
...
func (c *orderServiceClient) ListOrder(ctx context.Context, in *PaginationRequest, opts ...grpc.CallOption) (*ListOrderResponse, error) {
...
type OrderServiceServer interface {
	...
	ListOrder(context.Context, *PaginationRequest) (*ListOrderResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrder(context.Context, *PaginationRequest) (*ListOrderResponse, error) {
...
func _OrderService_ListOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ListOrder(ctx, req.(*PaginationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
